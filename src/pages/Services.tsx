  ...
  const services = [
    {
      ...
      features: ["React & Next.js Expertise", "Real-time Dashboards", "Complex State Management", "Progressive Web Apps"]
    },
    {
      icon: BrainCircuit,
      title: "AI Workflow Automation",
      desc: "Leverage the power of Large Language Models and autonomous agents to streamline your operations.",
      features: ["LLM Integration", "Custom AI Agents", "Natural Language Processing", "Automated Decision Systems"]
    },
    {
      icon: ShieldCheck,
      title: "Secure Backend Architecture",
      desc: "Robust, scalable server-side solutions designed with a security-first mindset.",
      features: ["Microservices Architecture", "API Design & Security", "Database Optimization", "High Availability Systems"]
    },
    {
      icon: RefreshCw,
      title: "DevOps & Cloud",
      desc: "Modern deployment pipelines and cloud infrastructure management for seamless scaling.",
      features: ["CI/CD Pipelines", "Cloud Migration", "Containerization (Docker/K8s)", "Infrastructure as Code"]
    },
    {
      icon: Database,
      title: "Data Engineering",
      desc: "Scalable data pipelines and storage solutions for modern data-driven enterprises.",
      features: ["ETL Pipelines", "Data Warehousing", "Real-time Processing", "Data Security"]
    },
    {
      icon: Lock,
      title: "Cybersecurity",
      desc: "Protecting your digital assets with advanced security measures and regular audits.",
      features: ["Penetration Testing", "Security Compliance", "Identity Management", "Threat Detection"]
    }
  ];
    ...
    <div className="pt-32 pb-24 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          >
            Comprehensive technical solutions designed to handle enterprise-level complexity and drive innovation.
          </motion.p>
        </div>
