  ...
  return (
    <div className="pt-32 pb-24 px-4 min-h-screen grid-bg relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black hero-gradient-text mb-4">Cookies Policy</h1>
        ...
        >
          <section className="space-y-4">
            ...
            <p className="text-lg">
              Cookies are small data files stored on your device to improve website functionality and user experience.
            </p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800 hover:border-primary/30 transition-colors">
          ...
          <section className="space-y-4">
            ...
            <p>
              Third-party services we use may place cookies subject to their own policies.
            </p>
          </section>
