  ...
  return (
    <div className="pt-32 pb-24 px-4 min-h-screen grid-bg relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black hero-gradient-text mb-4">Privacy Policy</h1>
        ...
        >
          <section className="space-y-4">
            ...
            <p className="text-lg">
              Welcome to Zentova Labs (“Company”, “we”, “our”, or “us”).
              We provide AI-powered document intelligence and automation services to businesses.
              This Privacy Policy explains how we collect, use, process, and protect information when you use our website and services.
            </p>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800">
                ...
                <ul className="space-y-2">
                  {["Name", "Email address", "Company name", "Phone number", "Uploaded documents", "Form messages", "Account details"].map((item, i) => (
              ...
              <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800">
                ...
                <ul className="space-y-2">
                  {["IP address", "Browser type", "Device information", "Pages visited", "Usage analytics", "Cookie data"].map((item, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm">
                      <div className="w-1 h-1 rounded-full bg-primary/40" />
                      {item}
                    </li>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              {[
                ...
                <p key={i} className="pl-6 border-l-2 border-primary/20 italic">{text}</p>
              ))}
            </div>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <section className="space-y-4">
              ...
              <p className="text-sm">
                We implement industry-standard safeguards including: Encrypted data transmission (HTTPS), Secure cloud infrastructure, Access controls, and Restricted internal access.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm">
                We may use third-party providers including cloud hosting, analytics tools, and AI service providers. These providers operate under their own privacy policies.
              </p>
            </section>
          </div>
