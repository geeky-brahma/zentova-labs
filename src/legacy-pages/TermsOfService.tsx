...
export const TermsOfService = () => {
  return (
    <div className="pt-32 pb-24 px-4 min-h-screen grid-bg relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black hero-gradient-text mb-4">Terms of Service</h1>
          <p className="text-slate-500 font-medium tracking-widest uppercase text-sm">Effective Date: March 3, 2026</p>
        </motion.div>
        ...
        >
          <section className="space-y-4">
            ...
            <p className="text-lg">
              By accessing or using zentovalabs.com or our services, you agree to these Terms of Service.
          ...
          <section className="space-y-4">
            ...
            <p>
              We provide AI-powered document intelligence, automation tools, and consulting services.
              Services may include document analysis, contract summaries, extraction systems, and workflow automation tools.
              All outputs are informational in nature.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-rose-500/5 p-6 rounded-2xl border border-rose-500/20">
              <p className="text-slate-300 italic">
                Our services do not constitute legal, financial, tax, investment, or regulatory advice.
                Clients are solely responsible for reviewing AI-generated outputs and obtaining professional advice when necessary.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              All software, systems, and proprietary tools remain the intellectual property of Zentova Labs.
              Clients retain ownership of their uploaded documents and data.
            </p>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <section className="space-y-4">
              ...
              <p className="text-sm">
                Fees are defined in separate agreements. Payments are non-refundable unless explicitly stated. Late payments may result in suspension of services.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm">
                To the maximum extent permitted by law, we are not liable for indirect damages. Total liability shall not exceed fees paid in the preceding 3 months.
              </p>
            </section>
          </div>
